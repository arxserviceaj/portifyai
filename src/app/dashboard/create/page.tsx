...
export default function CreatePortfolioPage() {
  ...
  const generateWithAI = (state: FormState) => {
    ...
    const projectTitle =
      `Showcase: ${projectIdea.charAt(0).toUpperCase()}${projectIdea.slice(1)}`;

    const projectDesc =
      `An end-to-end project where ${name.split(\" \")[0]} designed and built a ${projectIdea}. The focus was on fast iteration, clear storytelling, and a modern visual system that feels like a premium SaaS product.`;
      ...
      <div className=\"mx-auto flex max-w-5xl flex-col gap-8 px-4 py-10 md:px-6\">
        <header className=\"space-y-2\">
          ...
          <p className=\"text-sm text-zinc-400 max-w-xl\">
            Fill in a few details. We’ll generate a polished bio and project section automatically, which you can always refine later.
          </p>
        </header>
        ...
        >
          ...
          <div className=\"flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between\">
            <p className=\"text-xs text-zinc-500\">
              AI will generate your bio and project write-up from the details above. You can regenerate later.
            </p>
